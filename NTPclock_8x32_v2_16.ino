...
const unsigned long retryDelay  = 300000;         // retry 5 min later if time query failed
...
unsigned long tpinterogare1 = 900000;  // 15 minute

unsigned long tpceas;
unsigned long tpinterogare0 = 500;

unsigned long tpsoare;
unsigned long tpinterogare2 = 300000;   // 5 minute
